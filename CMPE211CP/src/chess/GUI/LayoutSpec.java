...
public class LayoutSpec {
	...
	private static final HashSet<String> allSpecs = new HashSet<String>(Arrays.asList("x", "y", "fill", "height", "ht",
			"width", "wid", "anchor", "weightx", "weighty", "ileft", "iright", "itop", "ibottom"));
	...
	static {
		for (Object[] pair : new Object[][] { { "center", 10 }, { "north", 11 }, { "south", 15 }, { "east", 13 },
				{ "west", 17 }, { "southwest", 16 }, { "southeast", 14 }, { "northwest", 18 }, { "northeast", 12 },
				{ "remainder", 0 }, { "rest", 0 }, { "horizontal", 2 }, { "horiz", 2 }, { "vertical", 3 },
				{ "vert", 3 }, { "both", 1 } }) {
